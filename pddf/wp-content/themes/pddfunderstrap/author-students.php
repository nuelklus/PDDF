...
<div class="main-container categories-main-padding">
    <header>
        <h1 class="category-page-title"> Students </h1>
    </header>
    <div class="row" style="padding-top: 2rem;">
        ...
        $users = get_users(array('role' => 'student')); //get all the lists of users
                ...
                <div class="col-lg-4 center-author-content">
                    ...
                    <div class="socialc">
                        <?php if (!empty($facebook_url)) : ?>
                            <a href="<?php echo $facebook_url ?>"> <i class="fa fa-facebook-f"> </i> </a>
                        <?php endif; ?>

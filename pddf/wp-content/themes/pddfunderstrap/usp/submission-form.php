    ...
    <div id="user-submitted-posts">
        ...
        <form id="usp_form" method="post" enctype="multipart/form-data" action="">
            ...
            if (isset($_GET['success']) && $_GET['success'] == '1') :
                ...
                <?php }
                if (($usp_options['usp_email'] == 'show' || $usp_options['usp_email'] == 'optn') && ($usp_display_email)) { ?>
                ...
                if ($usp_options['usp_title'] == 'show' || $usp_options['usp_title'] == 'optn') { ?>
                    ...
                    <fieldset class="usp-title">
                        <label for="user-submitted-title" class="form-label"><?php esc_html_e('Post Title', 'usp'); ?></label>
                ...
                if (($usp_options['usp_category'] == 'show' || $usp_options['usp_category'] == 'optn') && ($usp_options['usp_use_cat'] == false)) { ?>
                    ...
                    <fieldset class="usp-category">
                        ...
                        <select class="form-control" id="user-submitted-category" <?php if (usp_check_required('usp_category')) echo $usp_required;
                                                                                    echo $multiple_cats . $category_class; ?> name="user-submitted-category[]">
                ...
                <?php }
                if ($usp_recaptcha_public && $usp_recaptcha_private && $usp_recaptcha_display == 'show' && $usp_recaptcha_version == 2) { ?>
                ...
                if ($usp_options['usp_images'] == 'show') { ?>
                                ...
                                <div id="user-submitted-image">
                                    ...
                                    if ($usp_minImages > 0) : ?>
                                        <?php for ($i = 0; $i < $usp_minImages; $i++) : ?>
                                            ...
                                            <input name="user-submitted-image[]" type="file" size="25" <?php echo $usp_required; ?> class="form-control-file usp-clone">
                                        <?php endfor; ?>
                                        <?php if ($usp_minImages < $usp_maxImages) : echo $usp_addAnother;
                                        endif; ?>
                                    <?php else : ?>

                                        <input name="user-submitted-image[]" type="file" size="25" class=" usp-clone" data-parsley-excluded="true">
                    ...
                    <div id="usp-submit" class="submitbtn">
                        ...
                        <input type="submit" class="usp-submit btn btn-primary btn-lg" id="user-submitted-post" name="user-submitted-post" value="<?php esc_attr_e('Submit Post', 'usp'); ?>">
